                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.game.year" id="year" class="form-control input-sm" placeholder="Enter the game's release year. [Optional]"/>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="rating" ng-model="ctrl.game.rating" id="rating" class="rating form-control input-sm" placeholder="Enter Rating Out of 10" required/>
                                  <div class="has-error" ng-show="myForm.$dirty">
